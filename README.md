...
<Cards>
  <Card title="Public" icon="fa-solid fa-code" href="/public" />

  <Card title="Beta" icon="fa-solid fa-vial" href="/beta" />
</Cards>
...
<Cards>
  <Card title="PLuG Web SDK" icon="fa-solid fa-message" href="/sdks/web/installation" />

  <Card title="PLuG Android SDK" icon="fa-solid fa-message" href="/sdks/mobile/android" />

  <Card title="PLuG iOS SDK" icon="fa-solid fa-message" href="/sdks/mobile/ios" />
</Cards>